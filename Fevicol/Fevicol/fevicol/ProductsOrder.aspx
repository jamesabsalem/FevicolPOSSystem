...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        function calcval(txtQuantity, txtUnitPrice, txtTotalAmount) {
            ...
            if (uPrice.length > 0) {unitPrice = uPrice;
            }
                        ...
                        <div>
                            <div class="col-md-12 well">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:TextBox ID="txtQuantity" runat="server" AutoPostBack="True" CssClass="form-control form-group" OnTextChanged="txtQuantity_OnTextChanged"></asp:TextBox>
