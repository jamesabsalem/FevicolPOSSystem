...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:UpdatePanel ID="UpdatePanelMotherCompany" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <dx:TabPage Text="Receive Product">
                <ContentCollection>
                    <dx:ContentControl ID="CreatePurchesOrder" runat="server">
                        <div class="row">
                            <div class="col-md-12">
                                <%--<label class="col-md-1 control-label">Mother Company</label>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlMotherCompany" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlProductGroup_OnSelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorMotherCompany" runat="server" ErrorMessage="Please Enter Mother Company" SetFocusOnError="True" CssClass="label label-danger" ControlToValidate="ddlMotherCompany" ValidationGroup="productAdd"></asp:RequiredFieldValidator>
                                    <br />
                                </div>--%>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxUnitPrice" runat="server" Enabled="True"
                                        TargetControlID="txtUnitPrice" ValidChars="0123456789."></asp:FilteredTextBoxExtender>
                                    <br />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 text-left">
                                    <asp:Button ID="Button1" runat="server" Text="Add Mother Company" CssClass="btn btn yellow" OnClientClick="OpenModal('AddMotherCompany.aspx','Add Mother Company')" />
                                </div>

                                <div class="col-xs-6 text-right">
                                    <asp:Button ID="btnSave" runat="server" Text="Save Received Product" CssClass="btn btn-primary" OnClick="btnSave_OnClick" />
                                </div>
                            </div>
                            <%--<div class="col-md-12">
                                <div class="col-md-offset-2 col-md-2" style="text-align: left">
                                    <asp:Button ID="Button1" runat="server" Text="Save" CssClass="btn btn green" OnClick="btnSave_OnClick" />
                                </div>
                            </div>
                        <div class="col-md-12">
