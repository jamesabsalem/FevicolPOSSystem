    ...
    <div class="row">
        <div class="col-md-12">
            <div>
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="txtInvoiceNumber" runat="server" CssClass="form-control control-group"></asp:TextBox>
                </div>
                <label class="col-md-2 control-label">Invoice Collection</label>
                <div class="col-md-2">
